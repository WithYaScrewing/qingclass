  ...
  export default {
    ...
    mounted: function () {
      if (this.$route.query.share_id) {
        ...
        // this.shrepopup = true
        var data = {
          post_id: this.$route.query.chapter_id,
          share_type: 21,
          share_page: 'VipCard'
        }
        this.share(data)
...
// mc.background('http://mtapplet.meitudata.com/59e8765b6492c541.jpg',{
      ...
      updata: function (data) {
        this.$axios.achivement_chapter(data).then(res => {
          ...
          var str = this.items.chapters.chapter_soundbite
      ...
      init: function () {
        ...
        this.newimg(ctx, this.items.chapters.achievement_card_url, obj)
      },
        ...
        img.onload = function () {
          ...
          img.onload = function () {
            ...
            img.onload = function () {
              ...
              var str = _this.items.chapters.chapter_soundbite
              var stopnum = 0
              var engnum = 36
              var y = 810
              for (var i = 0; i < str.length / 36; i++) {
                textobj = {
                  x: 80 * _this.multiple,
                  y: y * _this.multiple,
                  color: '#fff',
